...
def gennerate_k(data_set, k):
    """
    Given 'data_set', which is an array of arrays,
    find the minmum and maximum for each coordinate, a range.
    Gennerate 'k' random points between the ranges.
...
def k_means(dataset, k):
    k_points = gennerate_k(dataset, k)
